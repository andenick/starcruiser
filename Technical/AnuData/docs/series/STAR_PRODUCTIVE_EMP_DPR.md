# Data Provenance Record: STAR_PRODUCTIVE_EMP
...
| Field | Value |
|-------|-------|
| Series ID | STAR_PRODUCTIVE_EMP |
| Name | Productive labor employment (Shaikh-Tonak classification) |
...
`USMINE + USCONS + MANEMP + (USTPU - USTRADE - USWTRADE), annual mean of monthly CES employment (thousands)`
