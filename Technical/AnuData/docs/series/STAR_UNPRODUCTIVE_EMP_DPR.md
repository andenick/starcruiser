# Data Provenance Record: STAR_UNPRODUCTIVE_EMP
...
| Field | Value |
|-------|-------|
| Series ID | STAR_UNPRODUCTIVE_EMP |
| Name | Unproductive labor employment (Shaikh-Tonak classification) |
...
`USWTRADE + USTRADE + USFIRE + USPBS + USEHS + USLAH + USSERV + USINFO + CES9091000001 + CES9092000001 + CES9093000001, annual mean of monthly CES employment (thousands)`

CONSTRUCTED CLASSIFICATION - heterodox (Shaikh-Tonak), NOT an official BLS series. See PRODUCTIVE_UNPRODUCTIVE_DPR_EPR.md.
