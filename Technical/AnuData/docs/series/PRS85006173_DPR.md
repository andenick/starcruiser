# Data Provenance Record: PRS85006173

## Quick Reference

| Field | Value |
|-------|-------|
| Series ID | PRS85006173 |
| Name | Nonfarm Business Sector: Labor Share (index, 2017=100), annual mean |
| Source | BLS via FRED |
| Units | index (2017=100) |
| Frequency | A (annual, complete-year-only) |
| Period | 1947-01-01 to 2025-01-01 |
| Observations | 79 |
| Construction | direct |
| Category | heterodox |
| Status | active |
...
`annual mean of quarterly FRED PRS85006173`
