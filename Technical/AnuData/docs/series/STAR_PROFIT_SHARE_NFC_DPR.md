# Data Provenance Record: STAR_PROFIT_SHARE_NFC
...
| Field | Value |
|-------|-------|
| Series ID | STAR_PROFIT_SHARE_NFC |
| Name | Nonfinancial corporate profit share / markup proxy |
...
`100 * T1.14 line 27 (NFC corporate profits w/ IVA+CCAdj) / line 17 (NFC gross value added)`
